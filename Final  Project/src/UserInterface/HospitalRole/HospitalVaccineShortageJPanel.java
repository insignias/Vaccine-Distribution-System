 ...
 * @author insignia
 */
public class HospitalVaccineShortageJPanel extends javax.swing.JPanel {
    ...
    public HospitalVaccineShortageJPanel(JPanel upc,UserAccount ua, HospitalEnterprise hosEnterprise, HospitalOrganization hosOrg, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void populateShortageTable(){
        ...
        for(WorkRequest wr : hosOrg.getWorkQueue().getWorkRequestList()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("HOSPITAL VACCINE SHORTAGE REPORT");
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 40, 420, 87));
