 ...
 * @author insignia
 */
public class HospitalManageShipmentOrderJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private UserAccount account;
    private HospitalEnterprise hosEnterprise;
    private HospitalOrganization hosOrganization;
    private EcoSystem ecoSystem;
    public HospitalManageShipmentOrderJPanel(JPanel upc, HospitalEnterprise hosEnterprise, UserAccount account, HospitalOrganization hosOrganization, EcoSystem ecoSystem) {
        initComponents();
        userProcessContainer = upc;
        this.account = account;
        this.hosEnterprise = hosEnterprise;
...
//        ShippingRequest sr = null;
            ...
            for(WorkRequest request : hosOrganization.getWorkQueue().getWorkRequestList()){
...
//              if(sr!=null){  
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 104, 375, 86));
        ...
        add(processjButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 210, -1, -1));
        ...
        add(refreshjButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 210, -1, -1));
        ...
        jLabel2.setText("HOSPITAL MANAGE SHIPMENT ORDER REQUEST");
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 283, 375, 86));
        ...
        if(request.getReceiver() != null){
            if(request.getReceiver().getPerson().getName().equals(account.getPerson().getName())){
                if(!request.getOrderResult().equals("Received")){
                    ...
                    HospitalProcessShipmentRequestJPanel dwpsrjp = new HospitalProcessShipmentRequestJPanel(userProcessContainer, hosEnterprise, account, hosOrganization, request, ecoSystem);
