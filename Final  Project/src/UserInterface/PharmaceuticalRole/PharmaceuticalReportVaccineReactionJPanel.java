 ...
 * @author insignia
 */
public class PharmaceuticalReportVaccineReactionJPanel extends javax.swing.JPanel {
    ...
    private Date d;
    public PharmaceuticalReportVaccineReactionJPanel(JPanel upc,UserAccount account, PharmaceuticalEnterprise phEnterprise, PharmaceuticalOrganization pharOrg,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PHARMACEUTICAL REPORT VACCINE REACTION");
...
//        }
        ...
        rr.setStatus("Sent");
        rr.setLocation(phEnterprise.getLocation());
        rr.setEnterpriseType(phEnterprise.getEnterpriseType().getValue());
        rr.setEnterpriseName(phEnterprise.getName());
