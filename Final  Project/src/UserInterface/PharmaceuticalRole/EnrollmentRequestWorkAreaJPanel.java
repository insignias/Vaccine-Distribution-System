...
import UserInterface.ProviderRole.ProviderRequestEnrollmentJPanel;
...
public class EnrollmentRequestWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public EnrollmentRequestWorkAreaJPanel(JPanel upc, UserAccount ua, PharmaceuticalEnterprise phenterprise, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PHARMACEUTICAL ENROLLMENT REQUEST WORK AREA");
    ...
    private void requestEnrollmentjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestEnrollmentjButtonActionPerformed
        RequestPharmaEnrollmentJPanel rpejp = new RequestPharmaEnrollmentJPanel(userProcessContainer, ua, phenterprise, ecoSystem);
        userProcessContainer.add("RequestPharmaEnrollmentJPanel", rpejp);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
