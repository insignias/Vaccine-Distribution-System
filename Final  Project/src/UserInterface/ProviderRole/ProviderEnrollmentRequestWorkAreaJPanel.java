 ...
 * @author relaince
 */
public class ProviderEnrollmentRequestWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private UserAccount ua;
    private ProviderEnterprise enterprise;
    private EcoSystem ecoSystem;
    public ProviderEnrollmentRequestWorkAreaJPanel(JPanel upc,UserAccount ua, ProviderEnterprise enterprise,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROVIDER ENROLLMENT REQUEST WORK AREA");
    ...
    private void requestEnrollmentjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestEnrollmentjButtonActionPerformed
        ProviderRequestEnrollmentJPanel prejp = new ProviderRequestEnrollmentJPanel(userProcessContainer, ua, enterprise, ecoSystem);
        userProcessContainer.add("ProviderRequestEnrollmentJPanel", prejp);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
