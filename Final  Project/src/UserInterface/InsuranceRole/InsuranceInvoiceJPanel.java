 ...
 * @author insignia
 */
public class InsuranceInvoiceJPanel extends javax.swing.JPanel {
    ...
    public InsuranceInvoiceJPanel(JPanel userProcessContainer, InsuranceEnterprise insuranceEnt, UserAccount ua, InsuranceOrganization insuranceOrg, EcoSystem ecoSystem) {
        initComponents();
...
//        InvoiceRequest invRequest = null;
        for(WorkRequest workRequest : insuranceOrg.getWorkQueue().getWorkRequestList()){
...
//        PaymentRequest paymentRequest = null;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("INSURANCE INVOICE");
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 540, 92));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 49, 540, 92));
    ...
    private void makePaymentjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_makePaymentjButtonActionPerformed
        ...
        InsurancePaymentJPanel ipjp = new InsurancePaymentJPanel(userProcessContainer, request, insuranceEnt, ua, insuranceOrg, ecoSystem);
        userProcessContainer.add("InsurancePaymentJPanel",ipjp);
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
