...
public class InsurancePaymentJPanel extends javax.swing.JPanel {
    ...
    private Date d;
    public InsurancePaymentJPanel(JPanel userProcessContainer, PatientRequest patientRequest, InsuranceEnterprise insuranceEnt, UserAccount ua, InsuranceOrganization insuranceOrg, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INSURANCE MANAGE PAYMENT ");
    ...
    private void makePaymentjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_makePaymentjButtonActionPerformed
        if(!patientRequest.getPaymentStatus().equals("Successful")){
            ...
            for(Enterprise e: n.getEnterpriseDirectory().getEnterpriseList()){
                ...
                if(patientRequest.getLocation().equals(e.getLocation())){
                    ...
                    if(e.getEnterpriseType().getValue().equals("Clinic")){
                        if(patientRequest.getEnterpriseName().equals(e.getName())){
