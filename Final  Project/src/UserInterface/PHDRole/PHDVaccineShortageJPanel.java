 ...
 * @author insignia
 */
public class PHDVaccineShortageJPanel extends javax.swing.JPanel {
    ...
    public PHDVaccineShortageJPanel(JPanel upc,UserAccount ua, PHDEnterprise phdEnterprise, PHDOrganization phdOrg, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void populateShortageTable(){
        ...
        for(WorkRequest wr : phdOrg.getWorkQueue().getWorkRequestList()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PHD VACCINE SHORTAGE REPORT");
        ...
        add(backJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, -1, -1));
