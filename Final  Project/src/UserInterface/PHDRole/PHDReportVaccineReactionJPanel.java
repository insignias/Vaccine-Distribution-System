 ...
 * @author insignia
 */
public class PHDReportVaccineReactionJPanel extends javax.swing.JPanel {
    ...
    private Date d;
    public PHDReportVaccineReactionJPanel(JPanel upc,UserAccount account, PHDEnterprise phdEnterprise, PHDOrganization phdOrg,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PHD REPORT VACCINE REACTION");
...
//        }
        ...
        rr.setStatus("Sent");
        rr.setLocation(phdEnterprise.getLocation());
        rr.setEnterpriseType(phdEnterprise.getEnterpriseType().getValue());
        rr.setEnterpriseName(phdEnterprise.getName());
