...
public class ManageEnrollmentRequestJPanel extends javax.swing.JPanel {
    ...
    public ManageEnrollmentRequestJPanel(JPanel upc, UserAccount ua, PHDOrganization phdOrg, EcoSystem ecoSystem) {
        initComponents();
        ...
        //DefaultTableModel dtm = (DefaultTableModel)enrreollmentRequestJTable.getModel();
        dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        add(backJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 211, -1, -1));

        jLabel1.setFont(new java.awt.Font("American Typewriter", 1, 18)); // NOI18N
        jLabel1.setText("PHD MANAGE ENROLLMENT REQUEST");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 400, -1));
        ...
        add(assignJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 164, -1, -1));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 160, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 51, 438, 95));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if(request.getReceiver() != null){
            if(request.getReceiver().getPerson().getName().equals(ua.getPerson().getName())){
                ...
                PHDProcessEnrollmentRequestJPanel phdpwrjp = new PHDProcessEnrollmentRequestJPanel(userProcessContainer,phdOrg,request,ecoSystem);
                userProcessContainer.add("PHDProcessWorkRequestJPanel", phdpwrjp);
                CardLayout layout = (CardLayout) userProcessContainer.getLayout();
