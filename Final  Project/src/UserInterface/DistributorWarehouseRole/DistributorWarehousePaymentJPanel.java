 ...
 * @author insignia
 */
public class DistributorWarehousePaymentJPanel extends javax.swing.JPanel {
    ...
    private Date d;
    public DistributorWarehousePaymentJPanel(JPanel userProcessContainer, PaymentRequest payRequest, DistributorWarehouseEnterprise dwEnt, UserAccount ua, DistributorWarehouseOrganization dwOrg, EcoSystem ecoSystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DISTRIBUTOR WAREHOUSE MAKE PAYMENT ");
    ...
    private void makePaymentjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_makePaymentjButtonActionPerformed
        if(payRequest.getPaymentStatus()!="DW Successful"){
        payRequest.setPaymentStatus("DW Successful");
        ...
        pr.setPaymentStatus("DW Successful");
        ...
        for(Network n : ecoSystem.getNetworkList()){
            ...
            for(Enterprise e: n.getEnterpriseDirectory().getEnterpriseList()){
                ...
                //if(dwEnt.getLocation().equals(e.getLocation())){
                    System.out.println("dwEnt.getLocation(): " +dwEnt.getLocation());
                    ...
                    if(e.getEnterpriseType().getValue().equals("Manufacturer")){
                        ...
                        for(Organization o : e.getOrganizationDirectory().getOrganizationList()){
                            ...
                            System.out.println("instance of manufacturer org");
                            org = o;
                            flag = true;
                            break;
                        }
