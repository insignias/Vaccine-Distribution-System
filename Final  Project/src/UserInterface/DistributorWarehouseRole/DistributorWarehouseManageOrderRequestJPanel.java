 ...
 * @author relaince
 */
public class DistributorWarehouseManageOrderRequestJPanel extends javax.swing.JPanel {
    ...
    public DistributorWarehouseManageOrderRequestJPanel(JPanel upc, UserAccount account, DistributorWarehouseEnterprise dwEnterprise, DistributorWarehouseOrganization dwOrganization, EcoSystem ecoSystem) {
        initComponents();
...
//        OrderRequest por = null;
    ...
    private void initComponents() {
        ...
        add(backJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 398, -1, -1));

        jLabel1.setFont(new java.awt.Font("American Typewriter", 1, 18)); // NOI18N
        jLabel1.setText("DISTRIBUTOR WAREHOUSE ORDER REQUEST WORK AREA");
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 83, 490, 99));
        ...
        add(refreshjButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, -1, -1));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 281, 490, 99));

        jLabel2.setFont(new java.awt.Font("American Typewriter", 1, 13)); // NOI18N
        jLabel2.setText("OUTGOING ORDER REQUEST:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 247, -1, -1));

        jLabel3.setFont(new java.awt.Font("American Typewriter", 1, 13)); // NOI18N
        jLabel3.setText("INCOMING ORDER REQUEST:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 55, -1, -1));
        ...
        if(request.getReceiver() != null){
            if(request.getReceiver().getPerson().getName().equals(account.getPerson().getName())){
                if(!request.getOrderResult().equals("Sent to Manufacturer")){
                    ...
                    DistributorWarehouseProcessOrderRequestJPanel dwporjp = new DistributorWarehouseProcessOrderRequestJPanel(userProcessContainer, account, dwEnterprise, dwOrganization, request, ecoSystem);
                    userProcessContainer.add("DistributorWarehouseProcessOrderRequestJPanel", dwporjp);
                    CardLayout layout = (CardLayout) userProcessContainer.getLayout();
